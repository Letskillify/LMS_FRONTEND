                        ...
                        <div className='d-flex justify-content-center align-items-center mx-auto mt-3'>
                            <Link to={'/'} className="">
                                <span className="">
                                    ...
                                    <h3 className='fw-bold border border-2 rounded p-3 text-white'>School Logo  <h6 className='mb-0  fw-bold border border-2 rounded-sm mt-2 p-1 text-white'>Staff Dashboard</h6></h3>
                                </span>
                            </Link>
                        </div>
