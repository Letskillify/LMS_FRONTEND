                ...
                >
                  <div className="card-body">
                    ...
                    <div className="Card-Header text-center">
                      <h4 className="text-uppercase fw-bold">LetSkillify</h4>
                      <img
                        style={{
                          width: "100px",
                          display: "block",
                    ...
                    <div className="row mt-4">
                      <div className="col-12 text-center">
                        ...
                        >
                          ...
                          <li>
                            <b>Class:</b>{" "}
                            {studentData?.enrollmentDetails?.course}th
                          </li>
                          <li>
                            <b>DOB:</b>{" "}
                            {studentData?.personalDetails?.dateOfBirth}
                          </li>
                          <li>
                            <b>Mobile No:</b> +
                            {studentData?.contactInfo?.mobile}
                          </li>
                          <li>
