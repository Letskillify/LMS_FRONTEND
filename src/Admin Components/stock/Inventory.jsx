...
const StockInventory = () => {
    ...
    const validationSchema = Yup.object({
        itemDetails: Yup.object({
            ...
            expDate: Yup.date()
                ...
                .test(
                    ...
                    function (value) {
                        const mfgDate = this.parent.mfgDate;
                        if (value && mfgDate) {
        ...
        gstInfo: Yup.object({
            ...
            setTax: Yup.number().min(0, "Tax must be a positive value").required("Tax is required"),
        ...
        accounting: Yup.object({
            ...
            gstPercent: Yup.number().min(0, "GST percentage cannot be negative").required("gst Percent is required"),
            discountPercent: Yup.number().min(0, "Discount percentage cannot be negative").required("discount Percent is required"),
        }),
        stockInfo: Yup.object({
            currentStock: Yup.number()
                .required("Current stock is required")
                .min(0, "Stock cannot be negative"),
            lowStockThreshold: Yup.number().min(0, "Threshold must be a positive number").required("low Stock Threshold is required"),
            purchaseHistory: Yup.array().of(
                Yup.object({
                    ...
                    supplier: Yup.string()
                        ...
                        .oneOf(["supplier1", "supplier2"], "Invalid supplier"),
                })
    ...
    useEffect(() => {
        axios.get("api/firm-account/get").then(response => {
    ...
    const handleEdit = async (v, id, index) => {
        try {
            ...
            if (res.status === 200) {
                const modalElement = document.getElementById(`edit_library_book_${index}`);
            ...
            toast.error(err.response ? err.response.data.message : "Error updating inventory", {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
    ...
    const handleDelete = (id) => {
        try {
            ...
            toast.error(err.response ? err.response.data.message : "Error Data Deleting inventory", {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="accordion border" id="itemDetailsAccordion">
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="itemDetailsHeading">
                                                    <button
                                                    ...
                                                    <div className="accordion-body border mb-4 rounded">
                                                        <div className="row g-3 mt-3">
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.itemDetails?.name}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                <Field
                                                                    ...
                                                                    onChange={(e) => {
                                                                        setFieldValue('itemDetails.category', e.target.value);
                                                                        setFieldValue('itemDetails.subCategory', '');
                                                                    }}
                                                                >
                                                                    <option value="">-- Select Category --</option>
                                                                    <option value="academic">Academic Supplies</option>
                                                                    <option value="uniforms">Uniforms and Accessories</option>
                                                                    <option value="sports">Sports Equipment</option>
                                                                    <option value="infrastructure">Infrastructure and Furniture</option>
                                                                    <option value="events">School Events</option>
                                                                </Field>
                                                                <div className="text-danger">{errors?.itemDetails?.category}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                >
                                                                    ...
                                                                    {values.itemDetails.category === 'academic' && (
                                                                        <>
                                                                            <option value="books">Books</option>
                                                                            <option value="notebooks">Notebooks</option>
                                                                            <option value="stationery">Stationery</option>
                                                                            <option value="artSupplies">Art Supplies</option>
                                                                            <option value="charts">Educational Charts</option>
                                                                        </>
                                                                    )}
                                                                    {values.itemDetails.category === 'uniforms' && (
                                                                        <>
                                                                            <option value="schoolUniform">School Uniform</option>
                                                                            <option value="shoes">Shoes and Socks </option>
                                                                            <option value="schoolBag">School Bag</option>
                                                                            <option value="idCards">ID Cards</option>
                                                                        </>
                                                                    )}
                                                                </Field>
                                                                <div className="text-danger">{errors?.itemDetails?.subCategory}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                <div className="text-danger">{errors?.itemDetails?.companyName?.name}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.itemDetails?.mfgDate}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.itemDetails?.expDate}</div>
                                                            </div>
                                                            <div className="col-12">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.itemDetails?.description}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        {/* GST Information */}
                                        <div className="accordion border mt-2" id="gstInfoAccordion">
                                            <div className="accordion-item">
                                                    ...
                                                    <div className="accordion-body border mb-3 rounded">
                                                        <div className="row g-3 mt-3">
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                >
                                                                    <option value="select">Select GST Applicable</option>
                                                                    <option value={true}>Yes</option>
                                                                    <option value={false}>No</option>
                                                                </Field>
                                                                <div className="text-danger">{errors?.gstInfo?.gstApplicable}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                <div className="text-danger">{errors?.gstInfo?.taxability}</div>
                                                            </div>
                                                        </div>
                                                        <div className="row g-3 mt-2">
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.gstInfo?.HSNcode}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.gstInfo?.productDescription}</div>
                                                            </div>
                                                        </div>
                                                        <div className="row g-3 mt-2">
                                                            <div className="col-12 col-md-6">
                                                                <label className="form-label">Type of Tax</label>
                                                                <Field
                                                                    as="select"
                                                                    className="form-control"
                                                                ...
                                                                <div className="text-danger">{errors?.gstInfo?.typeOfTax}</div>
                                                            </div>
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                />
                                                                <div className="text-danger">{errors?.gstInfo?.setTax}</div>
                                                            </div>
                                                        </div>
                                                        <div className="row g-3 mt-2">
                                                            <div className="col-12 col-md-6">
                                                                ...
                                                                <div className="text-danger">{errors?.gstInfo?.typeOfSupply}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="accordion-body border mb-4 rounded">
                                                    <div className="row g-3">
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            <div className="text-danger">{errors?.accounting?.unit}</div>
                                                        </div>
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.accounting?.amountPerUnit}</div>
                                                        </div>
                                                    </div>
                                                    <div className="row g-3 mt-2">
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.accounting?.quantity}</div>
                                                        </div>
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.accounting?.gstPercent}</div>
                                                        </div>
                                                    </div>
                                                    <div className="row g-3 mt-2">
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.accounting?.discountPercent}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="accordion-body border mb-4 rounded">
                                                    <div className="row g-3 mt-3">
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.stockInfo?.currentStock}</div>
                                                        </div>
                                                        <div className="col-12 col-md-6">
                                                            ...
                                                            />
                                                            <div className="text-danger">{errors?.stockInfo?.lowStockThreshold}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="accordion-item border mt-2 mb-4">
                                            <h2 className="accordion-header" id="headingPurchaseHistory">
                                                <button
                                                    className="accordion-button collapsed fs-4"
                                                    type="button"
                                                    data-bs-toggle="collapse"
                                            ...
                                            >
                                                <div className="accordion-body border">
                                                    <FieldArray
                                                        ...
                                                        render={(arrayHelpers) => (
                                                            <>
                                                                {values.stockInfo.purchaseHistory.map((_, index) => (
                                                                ...
                                                                <div className="row g-2 mb-3">
                                                                    <div className="col-12">
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            onClick={() =>
                                                                                arrayHelpers.remove(
                                                                                    values.stockInfo.purchaseHistory.length - 1
                                                                                )
                                                                            }
                                                                        >
                                                                           <i class="fa fa-minus-circle" aria-hidden="true">Remove</i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </>
                            ...
                            <div className="table-responsive  ">
                                                    ...
                                                    <div className="modal-dialog modal-dialog-centered bg-transparent" style={{ maxWidth: '70%' }}>
                                                        <div className="modal-content">
                                                            ...
                                                            <Formik
                                                                ...
                                                                // validationSchema={validationSchema}
                                                                onSubmit={(Values) => handleEdit(Values, Inventory._id, index)}
                                                            >
                                                                {({ values }) => (
                                                                    <Form className="card p-4 ">
                                                                                    ...
                                                                                    <div className="accordion-body border m-4 rounded ">
                                                                                        <div className="row mt-3">
                                                                                            <div className="col-6 mb-3">
                                                                                                <label>inventory Name:</label>
                                                                                                <Field className="form-control" name="itemDetails.name" type="text" placeholder="Enter Your Inventory Name" />
                                                                                            ...
                                                                                            <div className="col-6 mb-3">
                                                                                                <label>Sub-Category:</label>
                                                                                                <Field className="form-control" name="itemDetails.subCategory">
                                                                                            ...
                                                                                            <div className="col-6 mb-3">
                                                                                                <label>Manufacturing Date:</label>
                                                                                                <Field className="form-control" name="itemDetails.mfgDate" placeholder="Enter Your Manufacturing Date" />

                                                                                            </div>
                                                                                            <div className="col-6 mb-3">
                                                                                                <label>Expiry Date:</label>
                                                                                                <Field className="form-control" name="itemDetails.expDate" placeholder="Enter Your Expiry Date" />
                                                                                ...
                                                                                >
                                                                                    <div className="accordion-body border m-4 rounded">
                                                                                        <div className="row mt-3">
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">GST Applicable</label>
                                                                                                <Field className="form-control" name="gstInfo.gstApplicable" />
                                                                                            </div>
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">Taxability</label>
                                                                                                <Field className="form-control" name="gstInfo.taxability">
                                                                                        ...
                                                                                        <div className="row ">
                                                                                            <div className="col-6 mt-2">
                                                                                                ...
                                                                                                <Field
                                                                                                    type="text"
                                                                                                    className="form-control"
                                                                                                    name="gstInfo.HSNcode" placeholder="Enter HSN Code"
                                                                                                />
                                                                                        ...
                                                                                        <div className="row mt-2">
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">Type of Tax</label>
                                                                                                <Field className="form-control" name="gstInfo.typeOfTax" />
                                                                                            </div>
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">Set Tax</label>
                                                                                                <Field className="form-control" name="gstInfo.setTax"
                                                                                                />
                                                                                        ...
                                                                                        <div className="row mt-2">
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">Type of Supply</label>
                                                                                                <Field className="form-control" name="gstInfo.typeOfSupply" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                >
                                                                                    <div className="accordion-body border m-4 rounded">
                                                                                        <div className="row mb-3 mt-3">
                                                                                            <div className="col-6">
                                                                                                <label className="form-label">Unit</label>
                                                                                                <Field className="form-control" name="accounting.unit" />
                                                                                            </div>
                                                                        ...
                                                                        <div className="accordion " id="accordionExample">
                                                                            ...
                                                                            <div className="accordion-item border mt-2 mb-4">
                                                                                ...
                                                                                {values.stockInfo.purchaseHistory.map((_, idx) => (
                                                                                    <div
                                                                                        id="collapsePurchaseHistory"
                                                                                        className="accordion-collapse collapse "
                                                                                        aria-labelledby="headingPurchaseHistory"
                                ...
                                {ShowView && SelectedInventory && (
                                    <div className="modal fade show" tabIndex="-1" style={{
                                        ...
                                        id="viewInventoryModal" aria-hidden="true">
                                        <div className="modal-dialog modal-dialog-centered modal-lg" style={{ maxWidth: '70%' }}>
                                            <div className="modal-content border-0 rounded-4 shadow-lg">
                                                ...
                                                <Formik>{({ errors, resetForm, values }) => (
                                                    <Form className="modal-body px-4 py-3">
                                                                        ...
                                                                        <div className="row mt-3">
                                                                            <div className="col-6 mb-3">
                                                                                ...
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.name}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mb-3">
                                                                                <label>Category:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.category}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mb-3">
                                                                                <label>Sub-Category:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.subCategory}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mb-3">
                                                                                <label>Company Name:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.companyName?.name}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mb-3">
                                                                                <label>Manufacturing Date:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.mfgDate ? new Date(SelectedInventory?.itemDetails?.mfgDate).toLocaleDateString() : ''}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mb-3">
                                                                                <label>Expiry Date:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.expDate ? new Date(SelectedInventory?.itemDetails?.expDate).toLocaleDateString() : ''}
                                                                                </div>
                                                                            ...
                                                                            <div className=" mb-3">
                                                                                <label>Description:</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.itemDetails?.description}
                                                                                </div>
                                                                                {/* <textarea className="form-control h-auto" name="itemDetails.description" type="text" placeholder="Enter Your Description" /> */}
                                                                    ...
                                                                    <div className="accordion-body border m-4 rounded">
                                                                        <div className="row mt-3">
                                                                            <div className="col-6">
                                                                                <label className="form-label">GST Applicable : </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.gstApplicable}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6">
                                                                                <label className="form-label">Taxability: </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.taxability}
                                                                                </div>
                                                                        ...
                                                                        <div className="row ">
                                                                            <div className="col-6 mt-2">
                                                                                <label className="form-label">HSN Code : </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.HSNcode}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6 mt-2">
                                                                                <label className="form-label">Product Description : </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.productDescription}
                                                                                </div>
                                                                        ...
                                                                        <div className="row mt-2">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Type of Tax : </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.typeOfTax}
                                                                                </div>
                                                                        ...
                                                                        <div className="row mt-2">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Type of Supply : </label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.gstInfo?.typeOfSupply}
                                                                                </div>
                                                                    ...
                                                                    <div className="accordion-body border m-4 rounded">
                                                                        <div className="row mb-3 mt-3">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Unit</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.accounting?.unit}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6">
                                                                                <label className="form-label">Amount Per Unit</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.accounting?.amountPerUnit}
                                                                                </div>
                                                                        ...
                                                                        <div className="row mb-3">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Quantity</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.accounting?.quantity}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6">
                                                                                <label className="form-label">GST Percentage</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.accounting?.gstPercent}
                                                                                </div>
                                                                        ...
                                                                        <div className="row mb-3">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Discount Percentage</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.accounting?.discountAmount}
                                                                                </div>
                                                                    ...
                                                                    <div className="accordion-body">
                                                                        <div className="row mb-3 mt-3">
                                                                            <div className="col-6">
                                                                                <label className="form-label">Current Stock</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.stockInfo?.currentStock}
                                                                                </div>
                                                                            ...
                                                                            <div className="col-6">
                                                                                <label className="form-label">Low Stock Threshold</label>
                                                                                <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                    {SelectedInventory?.stockInfo?.lowStockThreshold}
                                                                                </div>
                                                        ...
                                                        <div className="accordion " id="accordionExample">
                                                            ...
                                                            <div className="accordion-item border mt-2 mb-4">
                                                                ...
                                                                {SelectedInventory?.stockInfo?.purchaseHistory?.map((_, idx) => (
                                                                    <div
                                                                        id="collapsePurchaseHistory"
                                                                        className="accordion-collapse collapse "
                                                                        aria-labelledby="headingPurchaseHistory"
                                                                        ...
                                                                        <div className="accordion-body ">
                                                                            <div className="row mb-3">
                                                                                <div className="col-4">
                                                                                    <label>Date:</label>
                                                                                    <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                        {SelectedInventory?.stockInfo?.purchaseHistory[idx].date ? new Date(SelectedInventory?.stockInfo?.purchaseHistory[idx].date).toLocaleDateString() : ''}
                                                                                    </div>
                                                                                </div>
                                                                                <div className="col-4">
                                                                                    <label>Quantity Purchased:</label>
                                                                                    <div className="p-3 border rounded-3" style={{ background: "#fff" }}>
                                                                                        {SelectedInventory?.stockInfo?.purchaseHistory[idx].quantityPurchased}
                                                                                    </div>
                                                        ...
                                                        <button className="btn btn-primary text-center" onClick={() => setShowView(false)}>Close</button>
                                                    </Form>
                                                )}
                                                </Formik>
