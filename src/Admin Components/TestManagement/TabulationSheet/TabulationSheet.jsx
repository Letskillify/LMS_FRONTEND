...
const TabulationSheet = () => {
  ...
  const { TabulationSheet, InstituteId, Class, Section, Subject } =
      ...
      <div className="container mt-5 mb-5">
        <div className="card mb-4">
          <div className="card-body">
            <h3 className="text-start fw-bold">Manage Tabulation Sheet</h3>
        ...
        <div className="card">
          <div className="card-header d-flex justify-content-between align-items-center">
            <h5 className="fw-bold mb-0">Tabulation Sheet </h5>
            <input
              type="text"
