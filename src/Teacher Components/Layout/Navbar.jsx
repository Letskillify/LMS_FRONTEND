                ...
                <nav class="navbar navbar-expand-lg navbar-dark px-3 align-items-center">
                    ...
                    <div class="navbar-nav d-lg-flex align-items-center d-none">
                        ...
                        <div class="d-flex ">
                            ...
                            <Link to="/Salary">
                                <i class="fa menu-icon tf-icons fa-rupee text-white fs-6 border p-1 px-2 rounded " aria-hidden="true"></i>
                            </Link>
                            <Link to="/setting">
                                <i class="fa menu-icon tf-icons fa-cog text-white fs-6 border p-1 px-2 rounded " aria-hidden="true"></i>
                            </Link>
                        </div>
                    </div>
