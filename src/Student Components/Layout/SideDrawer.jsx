            ...
            <aside id="layout-menu" className={`layout-menu menu-vertical menu bg-menu-theme d-xl-block`} style={{ overflowY: 'scroll', height: '100vh', width: 'auto', scrollbarWidth: 'thin', transform: sidebaropen ? 'none' : '' }}>
                ...
                <div className='bg-themprimary'>
                    ...
                    <ul className="menu-inner ">
                        <div className='d-flex justify-content-center align-items-center mx-auto mt-3'>
                            <Link to={'/'} className="">
                                <span className="">
                                    ...
                                    <h3 className='fw-bold border border-2 rounded p-3 text-white'>School Logo  <h6 className='mb-0  fw-bold border border-2 rounded-sm mt-2 p-1 text-white'>Student Dashboard</h6></h3>
                                </span>
                            </Link>
                        </div>
                        ...
                        <NavLink activeclassname="active" className="menu-item" to="/parentdetails">
                        ...
                        <li className={`menu-item ${Homework ? 'active' : ''} ${OpenToggle == 'Homework' ? 'open' : ''}`} id='timetables' >
                            ...
                            <ul className="menu-sub">
                                <NavLink activeclassname="active" className="menu-item" to="/homework">
                                    <a href="javascript:void(0);" className="menu-link">
                                        <div>Work</div>
                                    </a>
                                </NavLink>
                                <NavLink activeclassname="active" className="menu-item" to="/submithomework">
                                    <a href="javascript:void(0);" className="menu-link">
                                        <div>Submit Work</div>
                                    </a>
                                </NavLink>
                        ...
                        <li className={`menu-item ${librarypaths ? 'active' : ''} ${OpenToggle == 'Library' ? 'open' : ''}`} id='Library' >
                            ...
                            <ul className="menu-sub">
                                ...
                                <NavLink activeclassname="active" className="menu-item" to="/bookrequest">
                                    <a href="javascript:void(0);" className="menu-link">
